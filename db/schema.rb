...
ActiveRecord::Schema.define(version: 20161020131459) do
  ...
  create_table "album_items", force: :cascade do |t|
    ...
    t.integer  "album_id"
    t.string   "photo"
    t.index ["album_id"], name: "index_album_items_on_album_id", using: :btree
  end
  ...
  create_table "albums", force: :cascade do |t|
    ...
    t.string   "title"
    t.index ["photographer_id"], name: "index_albums_on_photographer_id", using: :btree
  end
